...
public class ScreenRecorderUtil extends ScreenRecorder {
    ...
    public ScreenRecorderUtil (GraphicsConfiguration cfg, Rectangle captureArea, Format fileFormat,
                               Format screenFormat, Format mouseFormat, Format audiFormat, File movieFolder, String name) throws IOException, AWTException {
        super(cfg, captureArea, fileFormat, screenFormat, mouseFormat, audiFormat, movieFolder);
        this.name = name;
    }
...
//                new Format(MediaTypeKey, MediaType.VIDEO, EncodingKey, ENCODING_AVI_RLE,
//                        CompressorNameKey, ENCODING_AVI_RLE,
